<script>
    ...
    import { paused, minutes, seconds, toggleTimer, setTime, cleanup } from "$lib/sharedStates/timer.js";
...
>
    <div class="flex flex-row gap-1.5">
        <img src="/assets/clock.svg" height="32" width="32" alt="clock" data-demon="primary" />
